...
function SignUp1() {
    ...
    const handleClick = (e) => {
        ...
        Axios.post("http://localhost:4000/route/createuser", data)
            .then((res) => {
                if (res.status === 200) {
                    setFlag(true);
                }
    ...
    const handleClick1 = (e) => {
        ...
        Axios.post("http://localhost:4000/route/verifyuser", data)
            .then((res) => {
                if (res.status === 200) {
                    setFlag1(true);
                    setFlag(false);
    ...
    const handleClick2 = (e) => {
        ...
        Axios.post("http://localhost:4000/route/create", data)
            .then((res) => {
                if (res.status === 200) {
